...
// Zod validation schema for signing up
const signUpSchema = z
  .object({
    ...
    confirmPassword: z
      .string()
      .min(1, { message: "Please confirm your security password" }),
  })
...
export default function SignUp() {
  ...
  const onSignUpSubmit = (data: SignUpSchema) => {
    ...
    //   login(data.email);
      ...
      setMessage({
        type: "success",
        text: "Account registered! Directing to workspace...",
      });
      setTimeout(() => {
          ...
          >
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-on-surface-variant/75 leading-relaxed font-sans max-w-70 mx-auto">
                Configure a secure keyspace instance.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                {socialLoading === "Apple" ? (
                  ...
                  <AppleIcon className="w-4 h-4 text-on-surface" />
                )}
                <span>Apple</span>
              </button>
