...
export const DemoSnippetss: Snippet[] = [
  {
    ...
    description:
      "Fully typed custom react hook for loading data using Fetch API with error handling, abort controls, and caching state.",
  ...
  },
  {
    ...
    description:
      "A responsive and beautiful modern bento-box style grids for showcase sections and dash configurations.",
  ...
  },
  {
    ...
    description:
      "A lightweight sliding-window rate limiting middleware for express APIs to prevent basic brute force and DDoS floods.",
  ...
  },
  {
    ...
    description:
      "Standard binary search implementation with detailed complexity notes.",
  ...
  },
  {
    ...
    description:
      "Robust server-side JSON Web Token decryption and payload signature verifier.",
  ...
  },
  {
    ...
    description:
      "Fast, contiguous index-based allocation mechanism inside an pre-allocated arena buffer.",
